...
function __VinylClassPatternShuffle(_name, _adHoc) : __VinylClassPatternCommon() constructor
{
    ...
    {
        if (VINYL_VALIDATE_CONFIG) __ValidateStruct(_patternData, ["type", "asset", "assets", "gain", "pitch", "effect chain", "label", "labels"]);
    ...
    static __Play = function(_emitter, _sound_UNUSED, _loop = false, _gain = 1, _pitch = 1, _pan = undefined)
    {
        ...
        return __VinylPatternGet(_pattern).__Play(_pattern, _emitter, _pattern, _loop, _gain, _pitch, _pan);
    }
