...
//Prefix to use for Vinyl macros relating to patterns, as generated by VinylSetupExportGMLMacros().
#macro VINYL_PATTERN_MACRO_PREFIX  "vin"

//Prefix to use for Vinyl macros relating to mixes, as generated by VinylSetupExportGMLMacros().
