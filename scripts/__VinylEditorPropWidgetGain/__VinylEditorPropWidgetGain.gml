...
{
    static _optionArray = ["Inherit", "Value", "Randomize", "Knob"];
    ...
    var _inheriting = (_originalOption == "Inherit");
    ...
    ImGui.BeginDisabled(_inheriting);
        ...
        {
            case "Value":
                _value[0] = ImGui.SliderFloat("##Gain " + _id, _value[0], 0, 2);
                _value[1] = _value[0];
            break;
    ...
    if (_option == "Knob")
    {
        ...
        ImGui.BeginDisabled(_inheriting);
            ...
            if (not _inheriting) _dataStruct.gainKnobOverride = _newOverride;
        ImGui.EndDisabled();
    }
}