...
function __VedClassRuleFilter() constructor
{
    ...
    static __BuildUI = function(_index)
    {
        if (ImGui.CollapsingHeader(__GetName() + "##" + string(_index), undefined, ImGuiTreeNodeFlags.DefaultOpen))
        {
            if (ImGui.BeginTable("Table", 3))
            {
                ...
                ImGui.BeginDisabled(not __useAssetTag);
                    ...
                    if (ImGui.RadioButton("AND", __assetTagOr)) __assetTagOr = false;
