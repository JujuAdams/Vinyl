...
function __VinylClassPatternQueue(_name, _adHoc) : __VinylClassPatternCommon() constructor
{
    ...
    {
        if (VINYL_CONFIG_VALIDATE_PATTERNS) __ValidateStruct(_patternData, ["type", "asset", "assets", "gain", "pitch", "transpose", "loop", "effect chain", "label", "labels", "behavior", "behaviour"]);
