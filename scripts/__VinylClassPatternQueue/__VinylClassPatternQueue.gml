...
function __VinylClassPatternQueue(_name, _adHoc) : __VinylClassPatternCommon() constructor
{
    ...
    {
        if (VINYL_CONFIG_VALIDATE_PATTERNS) __VinylValidateStruct(_patternData, ["type", "asset", "assets", "gain", "pitch", "transpose", "loop", "effect chain", "label", "labels", "behavior", "behaviour"]);
    ...
    static __Play = function(_parentInstance, _vinylEmitter, _sound_UNUSED, _loop = undefined, _gain = 1, _pitch = 1, _pan = undefined)
    {
        ...
        _instance.__Instantiate(self, _parentInstance, _vinylEmitter, __assetArray, _loop, _gain, _pitch, _pan, __behavior);
        return _instance;
    }
