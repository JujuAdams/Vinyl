...
function __VinylClassPatternQueue(_name, _adHoc, _child) : __VinylClassPatternCommon() constructor
{
    ...
    static __Initialize = function(_patternData = {})
    {
        ...
        if (VINYL_CONFIG_VALIDATE_PROPERTIES) __VinylValidateStruct(_patternData, ["type", "asset", "assets", "assetsWithTag", "gain", "pitch", "transpose", "loop", "effect chain", "stack", "stack priority", "persistent", "label", "labels", "behavior", "behaviour"]);
        ...
        var _behavior        = _patternData[$ "behavior"      ] ?? (_patternData[$ "behaviour"] ?? VINYL_DEFAULT_QUEUE_BEHAVIOR);
