    ...
    switch(_type)
    {
        ...
        case "patterns":
            ...
            repeat(array_length(_array))
            {
                ...
                if ((not _pattern.__child) && (_pattern.__patternType != "sound")) array_push(_return, _pattern.__name);
                ++_i;
            }
        break;
        ...
        case "assets":
            ...
            {
                var _pattern = _array[_i];
                if ((not _pattern.__child) && (_pattern.__patternType == "sound")) array_push(_return, audio_get_name(_pattern.__asset));
                ++_i;
            }
        break;
