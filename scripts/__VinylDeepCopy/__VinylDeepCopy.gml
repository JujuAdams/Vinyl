function __VinylDeepCopy(_value)
{
    return __VinylDeepCopyInner(_value, self, self);
}

function __VinylDeepCopyInner(_value, _oldStruct, _newStruct)
{
    var _copy = _value;
    ...
    else if (is_struct(_value))
    {
        ...
        repeat(array_length(_namesArray))
        {
            ...
            _copy[$ _name] = __VinylDeepCopyInner(_value[$ _name], _value, _copy);
            ++_i;
        }
    }
    else if (is_array(_value))
    {
        ...
        repeat(_count)
        {
            _copy[@ _i] = __VinylDeepCopyInner(_value[_i], _oldStruct, _newStruct);
            ++_i;
        }
    }
