...
function __VinylMultiselectAdd(_stateStruct, _resourceDict, _resourceName, _constructor)
{
    var _selectedDict = _stateStruct.__selectedDict;
    
    var _index = 1;
    var _newName = _resourceName + " " + string(_index);
    while(variable_struct_exists(_resourceDict, _newName))
    {
        ++_index;
        _newName = _resourceName + " " + string(_index);
    }
