...
function __VinylSystemReadProject__OLD(_projectData, _firstUpdate)
{
    static _projectDirectory = filename_dir(GM_project_filename) + "/";
    static _globalData       = __VinylGlobalData();
    
    static _oldSoundDict     = _globalData.__projectSoundDictionary;
    ...
    {    
        ...
        if (not variable_struct_exists(_oldSoundDict, _assetName))
        {
            ...
            if (_firstUpdate && (asset_get_type(_assetName) == asset_sound))
            {
                ...
                var _newAsset = new __VinylClassProjectSound(__VINYL_SOUND_TYPE.__WAD, _assetName);
            ...
            else
            {
                ...
                else
                {
                    ...
                    var _newAsset = new __VinylClassProjectSound(_type, _assetName, _absolutePath);
