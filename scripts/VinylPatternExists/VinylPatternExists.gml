...
/// will always return `true` if a sound asset is passed as the parameter for this function
/// regardless of whether a pattern has explicitly been created for the sound asset or not.
/// 
/// @param sound/pattern
