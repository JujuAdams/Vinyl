...
function VinylSetupMix(_mixName, _gainPattern = 1, _membersLoop = undefined, _mixParent = undefined, _metadata = undefined)
{
    ...
    {
        _existingPattern.__UpdateSetup(_gainPattern, _membersLoop, _mixParent, _metadata);
    }
    else
    {
        var _mixStruct = new __VinylClassMix(_mixName, _gainPattern, _membersLoop, _mixParent, _metadata);
